/* XYZZY copied from
  ...
  and patched one line:

      AndroidTextInput = requireNativeComponent('NonLeakingAndroidTextInput');
...
type IOSProps = $ReadOnly<{|
    ...
    dataDetectorTypes?: ?DataDetectorTypesType | $ReadOnlyArray<DataDetectorTypesType>,
...
const TextInput = createReactClass({
    ...
    render: function() {
        ...
        return <TextAncestor.Provider value={true}>{textInput}</TextAncestor.Provider>;
    },
