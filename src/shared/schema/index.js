...
export const WalletSettingsSchema = {
    ...
    properties: {
        ...
        /**
         * Determines if user has enabled OTP based two factor authentication on the wallet.
         */
        is2FAEnabled: {
            type: 'bool',
            default: false,
        ...
        /**
         * Determines if user has enabled YubiKey two factor authentication on the wallet.
         */
        is2FAEnabledYubikey: {
            type: 'bool',
            default: false,
