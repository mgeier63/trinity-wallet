...
describe('Reducer: settings', () => {
    ...
    describe('SET_YUBIKEY_SLOT', () => {
        it('should set yubikey  slot ', () => {
            const initialState = {
                yubikeySlot: 2,
            };
    ...
    describe('SET_YUBIKEY_ANDROIDREADERMODE', () => {
        it('should set yubikey androidReaderMode ', () => {
            const initialState = {
                yubikeyAndroidReaderMode: true,
            };
            ...
            const newState = reducer(initialState, action);
            const expectedState = {
                yubikeyAndroidReaderMode: false,
            };
            expect(newState).to.eql(expectedState);
        });
    });
